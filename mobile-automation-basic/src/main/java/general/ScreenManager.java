...
public class ScreenManager {
  ...
  private static CamerasPhotoScreen camerasPhotoScreen;
  private static DigCamScreen digCamScreen;
  ...
  public static void initPages(){
    ...
    camerasPhotoScreen = new CamerasPhotoScreen(driver);
    digCamScreen = new DigCamScreen(driver);
  ...
  public static CamerasPhotoScreen getCamerasPhotoScreen(){ return camerasPhotoScreen; }
  public static DigCamScreen getDigCamScreen(){ return digCamScreen; }
